...
myInput2.onkeyup = function () {
    if (myInput.value == myInput2.value && myInput.value != "") {
        ...
        document.getElementById("signup").outerHTML = '<input type="submit" class="btn" id="signup"/>';
        ...
        if (count == 4) {
            ...
            document.getElementById("signup").style.cursor = "not-allowed";
            document.getElementById("signup").outerHTML = '<input type="submit" class="btn" id="signup" disabled />';
        }
    }
    else {
