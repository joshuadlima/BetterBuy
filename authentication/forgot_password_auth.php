...
if (isset($_POST['user_auth'])) {
    ...
    if ($otp == $getotp) {
        ...
        $sql = "UPDATE `user_table` SET `user_password`='$newpassword' WHERE `username`='$username';";
        $result = mysqli_query($conn, $sql);

        header('Location: ../homepage/index.php');
    } else {
        echo "<script>alert(`wrong otp entered, password not changed`)</script>";
    }
}
?>
